...
async function getArticlesByCategory(category, page = 1, limit = 10) {
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$config$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].get(`/api/articles/category/${category}`, {
        params: {
            page,
            limit
        }
...
function ArticlesPage() {
    ...
    const fetchArticles = async ()=>{
        try {
            ...
            let response;
            if (selectedCategory) {
                response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$articles$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getArticlesByCategory"])(selectedCategory, page, limit);
            } else {
                response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$articles$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAllArticles"])(page, limit);
            }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f17fd344._.js.map