...
"[project]/lib/api/articles.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function getAllArticles(page = 1, limit = 10) {
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$config$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].get("/api/articles", {
        params: {
            page,
            limit
        }
...
async function searchArticles(query, page = 1, limit = 10) {
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$config$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].get("/api/articles/search", {
        params: {
            q: query,
            page,
            limit
...
async function getArticlesByCategory(category, page = 1, limit = 10) {
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$config$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].get(`/api/articles/category/${encodeURIComponent(category)}`, {
        params: {
            page,
            limit
        }
...
async function getArticleBySlug(slug) {
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$config$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].get(`/api/articles/${slug}`);
    return response.data.data.article;
}
async function getArticleById(id) {
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$config$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].get(`/api/articles/${id}`);
    return response.data.data;
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$articles$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/api/articles.ts [app-ssr] (ecmascript)");
...
function ArticlesPage() {
    ...
    const fetchArticles = async ()=>{
        try {
            ...
            setError(null);
            if (selectedCategory) {
                const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$articles$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getArticlesByCategory"])(selectedCategory, page, limit);
                ...
                const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$articles$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAllArticles"])(page, limit);
                setArticles(response.articles);
    ...
    const handleSearch = async ()=>{
        ...
        try {
            ...
            setError(null);
            setPage(1);
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$articles$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["searchArticles"])(searchQuery, 1, limit);
            setArticles(response.articles);
            setTotalPages(response.pagination.totalPages);
            setTotal(response.pagination.total);
        } catch (err) {
...
//# sourceMappingURL=_4c0f7c72._.js.map