...
function MedicinesPage() {
    ...
    const fetchMedicines = async ()=>{
        try {
            setLoading(true);
            setError(null);
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$medicines$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAllMedicines"])(page, limit);
    ...
    const handleSearch = async ()=>{
        ...
        try {
            ...
            setError(null);
            setPage(1);
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$medicines$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["searchMedicines"])(searchTerm, 1, limit);
            setMedicines(response.medicines);
            setTotalPages(response.pagination.totalPages);
            setTotal(response.pagination.total);
        } catch (err) {
...
//# sourceMappingURL=_5582de85._.js.map