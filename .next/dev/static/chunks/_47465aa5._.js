...
"[project]/app/lab-analyzer/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function LabAnalyzerPage() {
    ...
    async function fetchReports() {
        try {
            setLoading(true);
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$labReports$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getLabReports"])(page, 10);
            setReports(response.data.reports);
            setTotal(response.data.pagination.total);
            setTotalPages(response.data.pagination.totalPages);
        } catch (err) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(err.response?.data?.message || "Failed to load lab reports");
        } finally{
            setLoading(false);
        }
    }
    async function handleDelete(reportId) {
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$labReports$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteLabReport"])(reportId);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Lab report deleted successfully");
            fetchReports();
        } catch (err) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(err.response?.data?.message || "Failed to delete report");
        }
    }
    async function handleShare() {
        ...
        try {
            setSharing(true);
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$labReports$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["shareLabReportWithDoctor"])(selectedReport.id, doctorEmail);
...
_s(LabAnalyzerPage, "LxyzA37ysJZ9uKLHMs5sB3QDJZI=", false, function() {
    return [
...
function UploadForm({ onClose, onSuccess }) {
    ...
    const [testDate, setTestDate] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    ...
    async function handleSubmit(e) {
        ...
        try {
            setUploading(true);
            await __turbopack_context__.A("[project]/lib/api/labReports.ts [app-client] (ecmascript, async loader)").then((m)=>m.uploadLabReport(file, {
                    title,
                    testDate,
                    labName
                }));
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Lab report uploaded and analyzed successfully");
            onClose();
            onSuccess();
...
__turbopack_context__.k.register(_c1, "ErrorModal");
...
//# sourceMappingURL=_47465aa5._.js.map