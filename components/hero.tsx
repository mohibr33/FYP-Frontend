...
export default function Hero() {
  return (
    <section className="bg-white dark:bg-black py-16 md:py-20 px-4 transition-colors">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div className="hidden md:block relative">
            <div className="relative w-full h-[400px]">
              ...
              {/* Floating elements */}
              <div className="absolute top-8 left-12 bg-white dark:bg-black rounded-2xl p-4 shadow-lg animate-pulse border border-slate-100 dark:border-slate-700">
              ...
              <div className="absolute top-16 right-8 bg-white dark:bg-black rounded-2xl p-4 shadow-lg border border-slate-100 dark:border-slate-700">
                <div className="flex items-center gap-3">
              ...
              <div className="absolute bottom-16 left-8 bg-white dark:bg-black rounded-2xl p-4 shadow-lg border border-slate-100 dark:border-slate-700">
                <div className="flex items-center gap-3">
              ...
              <div className="absolute bottom-8 right-16 bg-white dark:bg-black rounded-2xl p-4 shadow-lg animate-pulse border border-slate-100 dark:border-slate-700">
                <div className="flex items-center gap-3">
