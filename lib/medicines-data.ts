export const medicinesData = [
  {
    ...
    productDetails: {
      ...
      whenNotToUse:
        "The combination of Empagliflozin + Linagliptin + Metformin HCl is contraindicated in patients with hypersensitivity to the active substances, to any other Sodium-Glucose-Co-Transporter-2 (SGLT2) inhibitor, to any other Dipeptidyl-Peptidase-4 (DPP-4) inhibitor, or to any of the excipients of the product.",
  ...
  },
  {
    ...
    productDetails: {
      howItWorks:
        "Lumateperone works by uniquely modulating several key chemical messengers, or neurotransmitters, in the brain: serotonin, dopamine, and glutamate. The precise way it improves symptoms of schizophrenia and bipolar depression is not fully understood, but this multi-targeted approach is central to its effects",
      ...
      whenNotToUse:
        "The medication is contraindicated in patients with a known hypersensitivity reaction to lumateperone or any of its components.",
      dosage: "Adults : 42mg once daily . Children : Not recommended . Or As directed by your physician .",
      storageYesOrNo: "Store this medicine at room temperature, away from direct light and heat.",
      precautions:
        "Lumateperone can cause or worsen high blood sugar (hyperglycemia), diabetes, and high cholesterol levels. Your doctor should monitor your blood sugar and lipid levels during treatment.",
      warning1:
        "Older adults with psychosis related to dementia who are treated with antipsychotic drugs like lumateperone have an increased risk of death. Lumateperone is not approved for use in this population.",
      warning2:
        "Antidepressants, including lumateperone, may increase the risk of suicidal thoughts and actions in young adults (up to age 24). Patients should be monitored closely, especially when treatment begins or dosage changes.",
      warning3: "Lumateperone can cause drowsiness, dizziness, and low blood pressure, increasing the risk of falls.",
      pregnancyCategory: "Always consult your physician before using any medicine.",
      drugInteractions:
        "CYP3A4 inducers e.g. Rifampin ; avoid. Strong and moderate CYP3A4 inhibitors e.g. Itraconazole and Diltiazem; reduce dose .",
    },
