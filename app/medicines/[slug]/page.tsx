  ...
  return (
    <main className="min-h-screen bg-slate-50 py-8 px-4">
      <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row gap-8 items-start">
            ...
            <div className="flex-1 space-y-6">
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-1">
                  <p className="text-lg text-slate-600">
                    Brand: <span className="font-semibold text-slate-800">{medicine.brand}</span>
                  </p>
                  {medicine.productDetails.generics && (
                    <p className="text-lg text-slate-600">
                      Generic: <span className="font-semibold text-slate-800">{medicine.productDetails.generics}</span>
                    </p>
                  )}
                  {medicine.productDetails.dosage && (
                    <p className="text-lg text-slate-600">
                      Dosage: <span className="font-semibold text-slate-800">{medicine.productDetails.dosage}</span>
                    </p>
                  )}
                </div>
              </div>
              ...
              <div className="flex items-center gap-2 text-amber-500">
                ...
                <span className="font-semibold text-lg text-slate-700">{avgRating}</span>
        ...
        {(medicine.productDetails.sideEffects || medicine.productDetails.whenNotToUse) && (
          <div className="grid lg:grid-cols-2 gap-6 mb-6">
              ...
              {medicine.productDetails.storageYesOrNo && (
                <div className="bg-cyan-50 rounded-xl shadow-sm border border-cyan-200 p-4">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <h3 className="font-medium text-cyan-900 text-sm">Storage</h3>
                  </div>
              ...
              {medicine.productDetails.pregnancyCategory && (
                <div className="bg-violet-50 rounded-xl shadow-sm border border-violet-200 p-4">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <h3 className="font-medium text-violet-900 text-sm">Pregnancy</h3>
                  </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="text-right">
                ...
                <div className="text-xs text-slate-500">{SAMPLE_REVIEWS.length} reviews</div>
              </div>
            </div>
                    ...
                    {[1, 2, 3, 4, 5].map((i) => (
                      <button
                        ...
                        className={`text-2xl transition-colors ${
                          reviewRating >= i ? "text-amber-400" : "text-slate-300"
                        }`}
                      >
                        ★
                      </button>
