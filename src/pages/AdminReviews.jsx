...
function AdminReviews() {
  ...
  return (
    <section>
      <div className="mb-8">
        <h1 className="text-5xl font-extrabold text-gray-900 mb-2">Reviews Management</h1>
        <p className="text-gray-600 text-lg">Manage medicine reviews and user feedback</p>
      </div>
      ...
      <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
        <table className="w-full">
          <thead className="bg-yellow-50">
            <tr>
              <th className="px-6 py-4 text-left font-semibold text-gray-700 w-32">User</th>
              <th className="px-6 py-4 text-left font-semibold text-gray-700 w-40">Medicine</th>
              <th className="px-6 py-4 text-left font-semibold text-gray-700 w-32">Rating</th>
              <th className="px-6 py-4 text-left font-semibold text-gray-700">Comment</th>
              <th className="px-6 py-4 text-left font-semibold text-gray-700 w-32">Date</th>
              <th className="px-6 py-4 text-left font-semibold text-gray-700 w-32">Status</th>
              <th className="px-6 py-4 text-right font-semibold text-gray-700 w-32">Actions</th>
            </tr>
          </thead>
            ...
            {loading ? (
              ...
              filtered.map((r) => (
                <tr key={r._id} className="hover:bg-yellow-50/30">
                  <td className="px-6 py-4 font-medium">{r?.user?.firstName || "iqra"}</td>
                  ...
                  <td className="px-6 py-4 text-gray-600 max-w-md">
                    <div className="line-clamp-3" title={r.reviewText || r.reviewTitle}>
